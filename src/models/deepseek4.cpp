...
ggml_tensor * llama_model_deepseek4::graph::build_top_k_mask(
    ...
    // Write the original selected rows directly into the dense -INF mask.
    // This keeps the canonical dense mask output while avoiding a separate
    // full-size add of the original KQ mask after set_rows.
